...
--========================================================--
local CTX = {}
CTX.UI = { BlurDefault = 15, BackgroundTransparencyDefault = 0 }
...
-- ==========================================
CTX.Motor6DPresets = {
    -- Valeurs extraites directement des ViewModels réels.
    -- Les modèles partagent les trois premiers joints ; seuls
    -- les joints spécifiques au couteau changent réellement.

    Common = {
        ["HumanoidRootPart.CameraBone"] = {
            C0 = CFrame.new(
                0, -0.0147750378, 0,
                1, 0, 0,
                0, 1, 0,
        ...
        ["HumanoidRootPart.LeftArm"] = {
            C0 = CFrame.new(
                -1.53539991, -1.22237408, -4.68488884,
                0, 0, -1,
                1, 0, 0,
                0, -1, 0
            ),
        ...
        ["HumanoidRootPart.RightArm"] = {
            C0 = CFrame.new(
                1.64681101, -1.22237408, -4.68488884,
                0, 0, -1,
                1, 0, 0,
                0, -1, 0
            ),
    ...
    Butterfly = {
        ["Knife.Handle.Upper"] = {
            C0 = CFrame.new(
                0.0554356575, -0.0684990883, 6.9797039e-05,
                1, -1.28165652e-06, 0.000172639295,
                -1.28165652e-06, 0.999889791, 0.0148469806,
                -0.000172639295, -0.0148469806, 0.999889791
            ),
            C1 = CFrame.new(
                0, 0, 0,
                1, 0, 0,
        ...
        ["Knife.Upper.Blade"] = {
            C0 = CFrame.new(
                -0.560006857, 0.0677471161, 0.000163197517,
                1, 0, 0,
                0, 1, 0,
                0, 0, 1
            ),
            C1 = CFrame.new(
                0.590000033, 0.100000381, 0,
                1, 0, 0,
                0, 1, 0,
                0, 0, 1
            )
        ...
        ["Knife.Upper.Lower"] = {
            C0 = CFrame.new(
                -0.632596016, -0.0341563225, -0.00139915943,
                1, 0, 0,
                0, 1, 0,
                0, 0, 1
            ),
            C1 = CFrame.new(
                -0.559999943, 0.0600004196, 0,
                1, 0, 0,
                0, 1, 0,
                0, 0, 1
            )
        ...
        ["RightArm.Handle"] = {
            C0 = CFrame.new(
                -0.164713323, 1.63211131, -0.0212717056,
                -0.00018966198, -0.0147710051, -0.999890864,
                1.40024349e-06, -0.999890924, 0.0147710051,
                -0.99999994, 1.40024349e-06, 0.000189602375
            ),
            C1 = CFrame.new(
                0, 0, 0,
                1, 0, 0,
    ...
    KarambitV2 = {
        ["RightArm.Handle"] = {
            C0 = CFrame.new(
                -0.267029703, 1.84894943, 0.328845978,
                0, 1, 0,
                -1, 0, 0,
                0, 0, 1
            ),
            C1 = CFrame.new(
                0.0666503906, -0.0953075737, -0.0319824219,
                1, 0, 0,
                0, 1, 0,
                0, 0, 1
            )
    ...
    BayonetV2 = {
        ["Knife.Handle.M9 Bayonet (Lanyard Loop&Text on Blade)"] = {
            C0 = CFrame.new(
                -0.537042618, -0.00219249725, 0.000237643719,
                1, 0, 0,
                0, 1, 0,
                0, 0, 1
            ),
            C1 = CFrame.new(
                0.00604991242, 0.00435947394, -0.023171233,
                4.36902046e-05, -1, 7.43195415e-07,
                -0.99942416, -4.37498093e-05, -0.0339327306,
                0.0339327306, 7.43195415e-07, -0.999424219
            )
        },

        ["RightArm.Handle"] = {
            C0 = CFrame.new(
                -0.2480551, 1.84769225, 0.25232029,
                0, 0, -1,
                0, -1, 0,
                -1, 0, 0
            ),
            C1 = CFrame.new(
                -0.150663972, -0.18584156, 0.0536966324,
                1, 0, 0,
                0, 1, 0,
                0, 0, 1
            )
    ...
    SkeletonV2 = {
        ["Knife.Handle.Cube.005"] = {
            C0 = CFrame.new(
                -0.147140324, 0.000727096864, 0.00164019247,
                1, 0, 0,
                0, 1, 0,
                0, 0, 1
            ),
            C1 = CFrame.new(
                0.00971623138, 0.00825412571, 3.81469727e-06,
                0, 1.00000012, 0,
                -1.00000012, 0, 0,
                0, 0, 1
            )
        ...
        ["RightArm.Handle"] = {
            C0 = CFrame.new(
                -0.24805513, 1.84769249, 0.310081482,
                0, 0, -1,
                0, -1, 0,
                -1, 0, 0
            ),
...
-- Compatibilité : les anciens réglages Position/Rotation restent disponibles
-- pour les sliders manuels. Le système Motor6D ci-dessus est désormais prioritaire
-- pour les modèles connus.
CTX.OffsetsConfig = {
    ["Default"] = {
...
local function appliquerButterflySurfaceAppearance(knifeModel)
    if not knifeModel or not CTX.Skin.EnabledSkin or CTX.Skin.Knife ~= "Butterfly" then
        return
    end

    local textureName = getSelectedSkinTexture()
    local sourceTexture = knifeTextures:FindFirstChild(textureName)
    if not sourceTexture or not sourceTexture:IsA("SurfaceAppearance") then
        return
    end

    for _, partName in ipairs({"Blade", "Lower", "Upper"}) do
        local meshPart = knifeModel:FindFirstChild(partName, true)
        if meshPart and meshPart:IsA("MeshPart") then
            ...
            local clone = sourceTexture:Clone()
            clone.Name = textureName
...
-- ==========================================
-- ==========================================
-- FONCTIONS : APPLICATION DES PRESETS Motor6D
-- ==========================================
local function findChildByPath(root, relativePath)
    if not root or not relativePath then
        return nil
    end
...
local function ensureRightArmHandleMotor(targetViewModel, currentKnife)
    if not targetViewModel or not currentKnife then
        return nil
    end

    local rightArm =
        targetViewModel:FindFirstChild("RightArm")
        or targetViewModel:FindFirstChild("Right Arm")

    local handle =
        currentKnife:FindFirstChild("Handle", true)
        or currentKnife:FindFirstChild("Main", true)

    if not rightArm or not handle then
        return nil
    end

    local motor = rightArm:FindFirstChild("Handle")
...
local function applyMotorPreset(targetViewModel, knifeName)
    if not targetViewModel or not knifeName then
        return 0, 0
    end

    local common = CTX.Motor6DPresets.Common or {}
    local specific = CTX.Motor6DPresets[knifeName] or {}

    local applied = 0
    local missing = 0

    local function applyPreset(relativePath, preset)
        local motor = findChildByPath(targetViewModel, relativePath)

        if not motor or not motor:IsA("Motor6D") then
            missing += 1
            if debugMode then
                warn(
                    "[rio V7.3][Motor6D] Introuvable : " ..
                    knifeName .. " -> " .. relativePath
                )
            end
            return
        end
    ...
    -- Joints communs aux cinq modèles connus.
    for relativePath, preset in pairs(common) do
        applyPreset(relativePath, preset)
    end

    -- Joints propres au modèle sélectionné.
    for relativePath, preset in pairs(specific) do
        applyPreset(relativePath, preset)
    end
...
local function applyManualHandleOffset(targetViewModel)
    if not targetViewModel then
        return
    end

    local manualOffset = CTX.Skin.ManualOffset or Vector3.zero
    local manualRotation = CTX.Skin.ManualRotation or Vector3.zero

    if manualOffset.Magnitude <= 0.00001
        and manualRotation.Magnitude <= 0.00001
    then
        return
    end

    local motor = findChildByPath(
        targetViewModel,
        "RightArm.Handle"
    )

    if not motor or not motor:IsA("Motor6D") then
        motor = findChildByPath(
            targetViewModel,
            "Right Arm.Handle"
        )
    end
    ...
    motor.C0 =
        motor.C0
        * CFrame.new(manualOffset)
        * CFrame.Angles(
            math.rad(manualRotation.X),
            math.rad(manualRotation.Y),
            math.rad(manualRotation.Z)
        )
end
...
local function actualiserViewmodel()
    ...
    -- 1. Sauvegarde unique du couteau serveur d'origine.
    if not CTX.Skin.BackupDone then
        local baseKnife = targetViewModel:FindFirstChild("Knife")
        if baseKnife then
            CTX.Skin.OriginalViewModelName = targetViewModel.Name
            CTX.Skin.OriginalBackup = baseKnife:Clone()
    ...
    -- ==========================================
    -- ÉTAPE A : GESTION DU MODÈLE
    -- ==========================================
    if CTX.Skin.EnabledModel then
        if not currentKnife
            or currentKnife:GetAttribute("CustomModelName") ~= CTX.Skin.Knife
        then
            ...
            local sourcePrefab =
                viewmodelsFolder:FindFirstChild(CTX.Skin.Knife)

            if sourcePrefab then
                local sourceKnife = sourcePrefab:FindFirstChild("Knife")

                if sourceKnife then
                    currentKnife = sourceKnife:Clone()
                    currentKnife:SetAttribute("CustomModel", true)
                    currentKnife:SetAttribute(
                        "CustomModelName",
                        CTX.Skin.Knife
                    )
                    currentKnife.Parent = targetViewModel
                end
            end
        end
    else
        -- Restauration de l'arme d'origine.
        if currentKnife
            and currentKnife:GetAttribute("CustomModel") == true
        then
            currentKnife:Destroy()
            currentKnife = nil
        end
        ...
        if not currentKnife and CTX.Skin.OriginalBackup then
            currentKnife = CTX.Skin.OriginalBackup:Clone()
            currentKnife.Parent = targetViewModel
        end
    end
    ...
    -- Le joint de poignée réel fait partie du ViewModel, pas du preset
    -- de position générique. On le reconnecte au Handle actuel.
    ensureRightArmHandleMotor(targetViewModel, currentKnife)

    -- ==========================================
    -- ÉTAPE B : PRESET Motor6D DU MODÈLE
    -- ==========================================
    if CTX.Skin.EnabledModel then
        ...
        applyManualHandleOffset(targetViewModel)

        if debugMode then
            print(
                string.format(
                    "[rio V7.3][Motor6D] %s | %d appliqués | %d introuvables",
                    CTX.Skin.Knife,
                    applied,
                    missing
                )
    ...
    -- ==========================================
    -- ÉTAPE C : SKIN / VFX / TRAILS
    -- ==========================================
    local mainMesh =
        currentKnife:FindFirstChild("Main")
        or currentKnife:FindFirstChild("Handle")

    if not mainMesh
        and currentKnife:FindFirstChild("Knife")
    then
        mainMesh =
            currentKnife.Knife:FindFirstChild("Main")
            or currentKnife.Knife:FindFirstChild("Handle")
    end
    ...
    if CTX.Skin.EnabledSkin then
        if CTX.Skin.Knife == "Butterfly" then
            appliquerButterflySurfaceAppearance(currentKnife)
        else
            local sourceTexture =
            ...
            if sourceTexture then
                for _, obj in ipairs(mainMesh:GetChildren()) do
        ...
        if not CTX.Skin.EnabledModel
            and CTX.Skin.OriginalBackup
        then
            local originalMain =
                CTX.Skin.OriginalBackup:FindFirstChild("Main")
                or CTX.Skin.OriginalBackup:FindFirstChild("Handle")

            if originalMain then
                for _, origObj in ipairs(originalMain:GetChildren()) do
                    if origObj:IsA("SurfaceAppearance")
                        or origObj:IsA("Texture")
                    then
    ...
    -- Gestion indépendante des VFX / Trails.
    local sourceVFX =
        knifeVFX:FindFirstChild(CTX.Skin.VFX)
...
local function injecterCouteauLance(thrownKnife)
    ...
    if CTX.Skin.EnabledSkin then
        if CTX.Skin.Knife == "Butterfly" and visualModel then
            appliquerButterflySurfaceAppearance(visualModel)
        else
            local sourceTexture =
                knifeTextures:FindFirstChild(
                    getSelectedSkinTexture()
...
ChangerTab:AddSection({Name = "Position / Rotation manuelle"})

ChangerTab:AddSlider({
    Name = "Position X", Min = -5, Max = 5, Default = 0,
    Increment = 0.05, ValueName = "studs",
    Callback = function(Value)
        local v = CTX.Skin.ManualOffset or Vector3.zero
        CTX.Skin.ManualOffset = Vector3.new(Value, v.Y, v.Z)
        actualiserViewmodel()
    end
})

ChangerTab:AddSlider({
    Name = "Position Y", Min = -5, Max = 5, Default = 0,
    Increment = 0.05, ValueName = "studs",
    Callback = function(Value)
        local v = CTX.Skin.ManualOffset or Vector3.zero
        CTX.Skin.ManualOffset = Vector3.new(v.X, Value, v.Z)
        actualiserViewmodel()
    end
})

ChangerTab:AddSlider({
    Name = "Position Z", Min = -5, Max = 5, Default = 0,
    Increment = 0.05, ValueName = "studs",
    Callback = function(Value)
        local v = CTX.Skin.ManualOffset or Vector3.zero
        CTX.Skin.ManualOffset = Vector3.new(v.X, v.Y, Value)
        actualiserViewmodel()
    end
})

ChangerTab:AddSlider({
    Name = "Rotation X", Min = -180, Max = 180, Default = 0,
    Increment = 1, ValueName = "°",
    Callback = function(Value)
        local v = CTX.Skin.ManualRotation or Vector3.zero
        CTX.Skin.ManualRotation = Vector3.new(Value, v.Y, v.Z)
        actualiserViewmodel()
    end
})

ChangerTab:AddSlider({
    Name = "Rotation Y", Min = -180, Max = 180, Default = 0,
    Increment = 1, ValueName = "°",
    Callback = function(Value)
        local v = CTX.Skin.ManualRotation or Vector3.zero
        CTX.Skin.ManualRotation = Vector3.new(v.X, Value, v.Z)
        actualiserViewmodel()
    end
})

ChangerTab:AddSlider({
    Name = "Rotation Z", Min = -180, Max = 180, Default = 0,
    Increment = 1, ValueName = "°",
    Callback = function(Value)
        local v = CTX.Skin.ManualRotation or Vector3.zero
        CTX.Skin.ManualRotation = Vector3.new(v.X, v.Y, Value)
        actualiserViewmodel()
    end
})
